...
|-------|------|--------|
|log|array, [ItemPriceContainerLog[]](price-container/home.md#itempricecontainerlog)|Array with price change log| 
...
|  Name | Type | Description |
|-------|------|--------|
|log|array, [TotalPriceContainerLog[]](price-container/home.md#totalpricecontainerlog)|Array with price change log| 
