...
You needs to get $obPropertyList object from current category item or with using [FilterPanel](property/component/component.md#filterpanel):
```php
...
You can add custom sorting for list of products with using **[shopaholic.sorting.get.list](product/event/event.md#shopaholicsortinggetlist)** event.
