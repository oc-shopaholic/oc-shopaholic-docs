...
|-------|------|--------|
|log|array, [ItemPriceContainerLog[]](modules/price-container/home.md#itempricecontainerlog)|Array with price change log| 
...
## ItemPriceContainerLog

### Field list

|  Name | Type | Description |
|-------|------|--------|
|mechanism|InterfacePromoMechanism|PromoMechanism object with discount logic|
...
|  Name | Type | Description |
|-------|------|--------|
|log|array, [TotalPriceContainerLog[]](modules/price-container/home.md#totalpricecontainerlog)|Array with price change log| 
