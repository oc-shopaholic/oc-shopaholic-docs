...
Method gets from request "shipping_type_id" field and returns [ShippingTypeItem](modules/shipping-type/item/item.md) class object.

### getAppliedCampaignList()

> Method available with **[Campaigns for Shopaholic](plugins/home.md#campaigns-for-shopaholic)** plugin

Method returns [CampaignCollection](modules/campaign/collection/collection) class object with active applied campaigns.
...
Method gets applied coupons and returns array with [Coupon](modules/coupon/model/model) models.
